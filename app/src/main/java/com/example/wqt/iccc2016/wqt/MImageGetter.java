...
public class MImageGetter implements ImageGetter {
    Context c;
    public int paddingSum;

    public MImageGetter( Context c,int paddingSum) {
        this.c = c;
        this.paddingSum = paddingSum;
    }
    ...
    public Drawable getDrawable(String source) {
        ...
        try {
            ...
            int dwidth = dm.widthPixels - paddingSum;//padding left + padding right
